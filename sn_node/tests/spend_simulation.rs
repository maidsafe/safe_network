        ...
        for (id, action_sender) in iter {
            ...
            if illicit_spend {
                ...
                if let Some(tx) = tx {
                    ...
                    println!("Wallet {id} is attempting a double spend");
                    continue;
                }
            }
        ...
        for spend in spends {
            ...
            match status {
                ...
                SpendStatus::Poisoned => {
                    ...
                    // todo: the outputs should still be valid + create a spend with this input and it should pass.
                }
                SpendStatus::DoubleSpend => {
                    ...
                    //todo: try to create a spend with this input and it should fail.
                }
            }
        }
    }
