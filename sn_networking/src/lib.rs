...
pub use self::{
    ...
    driver::{
        GetRecordCfg, NetworkBuilder, NetworkBuilderClient, PutRecordCfg, SwarmDriver, VerificationKind, MAX_PACKET_SIZE,
    },
...
impl NetworkClient {
    pub fn new(
        ...
        Self {
            inner: Arc::new(NetworkInnerClient {
