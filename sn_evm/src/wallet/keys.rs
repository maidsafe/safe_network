...
/// Returns sn_evm::MainSecretKey or None if file doesn't exist. It assumes it's hex-encoded.
...
/// Returns Some(sn_evm::MainPubkey) or None if file doesn't exist. It assumes it's hex-encoded.
