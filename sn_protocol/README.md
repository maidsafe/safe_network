...
- `SpendNotFound(DbcAddress)`: Indicates that a spend was not found.
  - Example: `Result::Err(Error::SpendNotFound(dbc_address))`
...
- `DbcAddress`: Address of a DBC (Digital Bearer Certificate) in the network.
